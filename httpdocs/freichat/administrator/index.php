        ...
        <div id="main" class="main" >
            ...
            <div id="container" class="container">
                <form method="post" action="index.php">
                    ...
                    &nbsp;<input id="fc_pass" style="width: 200px; border: 1px solid gray" type="password" name="pswd" value=''><br/>
                    <br/><span class="info">(defined in freichat/hardcode.php)</span><br/><br/>
