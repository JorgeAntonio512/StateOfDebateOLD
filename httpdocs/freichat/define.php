...
class DB_conn {
    ...
    public static function get_connection($host,$client_db_name,$username,$password,$port){
        ...
        if(self::$connected == true){
         ...
         try {
             self::$connection = new PDO('mysql:host=' . $host . ';'.$port.'dbname=' . $client_db_name, $username, $password, array(
