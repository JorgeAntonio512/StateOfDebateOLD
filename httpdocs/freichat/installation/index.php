...
if ($installed == true) {
    ...
    $_SESSION['error']="FreiChat is already installed on your server<br/>Hence for security reasons , the install has been locked.<br/>Yet if you want to install it again or think if FreiChatX is wrong <br/> please change the variable \$installed to false in ~/freichat/hardcode.php and then try again";
