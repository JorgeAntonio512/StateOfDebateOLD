            ...
            <a href='admin.php?freiload=moderate_users'><span onmouseover="mcolor(this)"  onmouseout="mblack(this)" class="container sprite-users_b" title="Moderate users"></span></a>
        </div>
        
        <script type="text/javascript">
            
            function maker_removed() {
                
                
                alert("The theme maker has been disabled for this version since it is undergoing some major changes.");
            ...
            <div style="position: fixed;bottom: 0px;text-align: center;margin: 0px auto;width:60%;font-size:small;">
                ...
                Current Version: 8.3<br/>
                Latest Version: <img src="http://codologic.com/page/latest_ver.png" style="display: inline;height:10px"/><br/>
