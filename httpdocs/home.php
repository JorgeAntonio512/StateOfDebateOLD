...
<div id="wrapper">
	...
	<div style="margin-top:50px;" id="topnav"><!--This is temp, remove margin-->
		<ul>
			<li style="padding-left:30px;"><a href="home.php">Home</a></li>
...
<div style="clear:right;" class="rightBox">
            ...
            <div id="view2" class="tabcontent">
				...
				<?php
					$query1 = mysql_query("SELECT * FROM debates RIGHT JOIN users ON debates.UID=users.UID ORDER BY debates.rating DESC LIMIT 0, 10")OR DIE(mysql_error());
					while($row = mysql_fetch_array($query1))
					{
						?>
